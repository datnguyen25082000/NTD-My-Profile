...
export class Skill extends React.Component {
  ...
  handleClickSkill = (event) => {
    ...
    parent
      .getElementsByClassName("skill-progress")[0]
      .classList.toggle("hiden-skill");
  };
    ...
    return (
      ...
      >
        <div
          ...
          data-reveal-delay={this.props.delay}
        >
          <a href="javascript:void(0)">
            <div
              className="tiles-item-inner"
              onClick={(e) => this.handleClickSkill(e)}
            >
