    ...
    <section {...props} className={outerClasses}>
      <div className="container-sm" style={{ position: "relative" }}>
        <div>
          <div
            className="home-page"
            style={{ minHeight: "100vh", position: "relative", top: "-80px" }}
          >
            <div style={{ position: "absolute", top: "35%", width: "100%" }}>
              <h1 className="line-1 anim-typewriter" data-reveal-delay="2000">
                ...
                <div className="col-8">
                  <div style={{ textAlign: "left" }}>
                    <div
                      ...
                      data-reveal-delay="3100"
                    >
                      <h1 style={{ margin: "0px" }}>NGUYEN TAN DAT</h1>
                      <div
                        className="reveal-from-bottom"
                        data-reveal-delay="3200"
                      >
                        <h3>Web Developer</h3>
                        <button
          ...
          <div>
            <div className={innerClasses} id="about-me">
              ...
              <div className="row">
                ...
                <div
                  className="col-12 col-sm-7 info"
                ...
                >
                  ...
                  <p>
                    <i class="far fa-calendar-alt mr-2 mt-4"></i> &#160;25
                    August, 2000 - Quang Ngai, Viet Nam
                  </p>

                  <p>
                    <i class="fas fa-school mr-2"></i> University of Science, Ho
                    Chi Minh, Viet Nam
                  </p>
                  <p>
                  ...
                  <span>
                    ...
                    in project management and customer relations in the future.
                  </span>
                </div>
              </div>
            </div>
